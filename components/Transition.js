  ...
  return (
    <>
      ...
      bg-[#2e2257]'
        ...
        animate="animate"
        exit="exit"
        transition={{delay: 0.2, duration:0.6, ease:'easeInOut'}}>1
        </motion.div>
      ...
      bg-[#3b2d71]'
        ...
        animate="animate"
        exit="exit"
        transition={{delay: 0.4, duration:0.6, ease:'easeInOut'}}>1
        </motion.div>
      ...
      bg-[#4b3792]'
        ...
        animate="animate"
        exit="exit"
        transition={{delay: 0.6, duration:0.6, ease:'easeInOut'}}>1
        </motion.div>
    </>
  );
};
